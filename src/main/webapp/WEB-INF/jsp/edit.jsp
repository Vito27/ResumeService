...
<%@ page import="com.vito.model.SectionType" %>
<%@ page import="com.vito.util.DateUtil" %>
...
<section>
    <form method="post" action="resume" enctype="application/x-www-form-urlencoded">
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.vito.model.Organization.Position"/>
                                <dl>
                                    <dt>Start date:</dt>
                                    <dd>
        ...
        <button><a href="resume" class="button" >Cancel</a>
            <style type="text/css">
                A {
